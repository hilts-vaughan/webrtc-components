...
<html lang="en">
<head>
    <title>Code coverage report for src/Observable.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/Observable.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; Observable.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {Observer} from './Observer';
...
&nbsp;
  ...
  forEach(next: (value: T) =&gt; void, thisArg: any, PromiseCtor?: PromiseConstructor): Promise&lt;void&gt; {
    if (!PromiseCtor) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (root.Promise) {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  [SymbolShim.observable]() {</span>
